...
export default function GrowthOS({ content, locale, design, preview, variantPath }: DesignProps) {
  ...
  return (
    <main className={styles.page} dir={locale === "ar" ? "rtl" : "ltr"} data-layout="os">
      <a className={styles.skip} href="#work">Skip to work</a>
      <nav className={styles.nav} aria-label="Portfolio">
        <Link href={variantPath || "/" + locale} className={styles.brand}><span>K/04</span><b>{content.profile.name}</b></Link>
        <div>
      ...
      <section className={styles.hero} aria-labelledby="hero-title">
        <div className={styles.heroCopy}>
          <p className={styles.eyebrow}>Product Command OS · modular product cockpit</p>
        ...
        <div className={styles.heroVisual} aria-label={content.profile.name}>
          ...
          <div className={styles.signature} aria-hidden="true"><span>04</span><b>SaaS Growth OS</b></div>
        </div>
      </section>
